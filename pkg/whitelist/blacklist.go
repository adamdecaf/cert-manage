...
// Generated on 2018-08-15T06:35:26Z by adam, any modifications will be overwritten
package whitelist
...
var blacklistedFingerprints = []string{
	...
	// CN=DSDTestProvider,OU=DSDTestProvider,O=DSDTestProvider
	`0f912fd7be760be25afbc56bdc09cd9e5dcc9c6f6a55a778aefcb6aa30e31554`,
	// CN=KEIO UNIV.CA 2,O=Keio University,C=JP
	`159ca03a88897c8f13817a212629df84ce824709492b8c9adb8e5437d2fc72be`,
	...
	// CN=Egypt Trust Class 3 Managed PKI Enterprise Administrator CA,OU=VeriSign Trust Network+OU=Terms of use at https://www.egypttrust.com/repository/rpa (c)08,O=Egypt Trust,C=EG
	...
	`42187727be39faf667aeb92bf0cc4e268f6e2ead2cefbec575bdc90430024f69`,
	// CN=DigiNotar Services 1024 CA,O=DigiNotar,C=NL
	`450f1b421bb05c8609854884559c323319619e8b06b001ea2dcbb74a23aa3be2`,
	// CN=Certification Authority of WoSign,O=WoSign CA Limited,C=CN
	`4b22d5a6aec99f3cdb79aa5ec06838479cd5ecba7164f7f22dc1d65f63d85708`,
	// CN=addons.mozilla.org,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
	...
	`79f69a47cfd6c4b4ceae8030d04b49f6171d3b5d6c812f58d040e586f1cb3f14`,
	// CN=Egypt Trust Class 3 Managed PKI SCO Administrator CA,OU=VeriSign Trust Network+OU=Terms of use at https://www.egypttrust.com/repository/rpa (c)08,O=Egypt Trust,C=EG
	`7abd72a323c9d179c722564f4e27a51dd4afd24006b38a40ce918b94960bcf18`,
	// CN=Class 1 Primary CA,O=Certplus,C=FR
	`7d8ce822222b90c0b14342c7a8145d1f24351f4d1a1fe0edfd312ee73fb00149`,
	// OU=UPKI+OU=NII Open Domain CA - G2,O=National Institute of Informatics,L=Academe2,C=JP
	`817d4e05063d5942869c47d8504dc56a5208f7569c3d6d67f3457cfe921b3e29`,
	// CN=mail.google.com,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
	`8290cc3fc1c3aac3239782c141ace8f88aeef4e9576a43d01867cf19d025be66`,
	// CN=xs4all.nl,OU=Domain Control Validated+OU=PositiveSSL
	`83618f932d6947744d5ecca299d4b2820c01483947bd16be814e683f7436be24`,
	// CN=DigiNotar Root CA,O=DigiNotar,C=NL
	...
	// CN=login.yahoo.com,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
	`933f7d8cda9f0d7c8bfd3c22bf4653f4161fd38ccdcf66b22e95a2f49c2650f8`,
	// CN=www.google.com,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
	`9532e8b504964331c271f3f5f10070131a08bf8ba438978ce394c34feeae246f`,
	...
	// CN=NIC CA 2014,OU=Certifying Authority,O=National Informatics Centre,POSTALCODE=110003,STREET=Lodhi Road\, New Delhi,ST=Delhi,C=IN
	`a8e1dfd9cd8e470aa2f443914f931cfd61c323e94d75827affee985241c35ce5`,
	// CN=Superfish\, Inc.,O=Superfish\, Inc.,L=SF,ST=CA,C=US
	`b6fe9151402bad1c06d7e66db67a26aa7356f2e6c644dbcf9f98968ff632e1b7`,
	...
	// CN=NIC Certifying Authority,OU=NICCA,O=National Informatics Centre,L=New Delhi,ST=Delhi,C=IN
	`e4f9a3235df7330255f36412bc849fb630f8519961ec3538301deb896c953da5`,
	// CN=login.skype.com,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
	`ead610e6e90b439f2ecb51628b0932620f6ef340bd843fca38d3181b8f4ba197`,
	// CN=eDellRoot
	`ec30c9c3065a06bb07dc5b1c6b497f370c1ca65c0f30c08e042ba6bcecc78f2c`,
	// CN=*.sslip.io,OU=Domain Control Validated+OU=PositiveSSL Multi-Domain
	`f3bae5e9c0adbfbfb6dbf7e04e74be6ead3ca98a5604ffe591cea86c241848ec`,
	// CN=Fraunhofer Service CA 2007,OU=Fraunhofer Corporate PKI,O=Fraunhofer,C=DE
	`f4a5984324de98bd979ef181a100cf940f2166173319a86a0d9d7c8fac3b0a8f`,
	// CN=login.yahoo.com,OU=Tech Dept.+OU=Hosted by GTI Group Corporation+OU=PlatinumSSL,O=Google Ltd.,POSTALCODE=38477,STREET=Sea Village 10,L=English,ST=Florida,C=US
